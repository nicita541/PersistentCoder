...
def test_trace_log_records_model_actions_and_success(
    tmp_path,
):
    trace_path = (
        tmp_path / "planner_trace.log"
    )
    ...
    assert '"event": "plan_start"' in trace_text
    assert '"event": "llm_response"' in trace_text
    assert '"event": "parsed_action"' in trace_text
    assert '"event": "tool_result"' in trace_text
    assert '"event": "validation"' in trace_text
    assert '"event": "plan_success"' in trace_text
